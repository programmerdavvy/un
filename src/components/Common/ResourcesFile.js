            ...
            <CardBody>
              ...
              <CardText>
                ...
                <div className="d-flex p-2 justify-content-center">
                  <Link
                    to="#"
                    className="waves-effect waves-light w-50 text-dark font-weight-bold"
                  >
            <i className="fas fa-download m-2"></i> Download File
                  </Link>
                </div>
              </CardText>
            </CardBody>
